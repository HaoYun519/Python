...
# 分析資料: 安裝數量的各種統計數據
# print(data["Installs"][10472]) # 錯誤資料 Free
...
condition=data["App"].str.contains(keyword, case=False)  # case=False忽略大小寫  case:如果為True，則區分大小寫。
print(data[condition]["App"])
# print("包含關鍵字的應用程式數量", data[condition].shape[0])

# keyword=input("請輸入關鍵字: ")
# condition=data["Category"].str.contains(keyword, case=False)  # case=False忽略大小寫
